...
def main():
    ...
    menu = ["Main App", "Food Recommender", "About"]
    ...
    if choice == "Main App":
        ...
        st.write("Welcome to the **Food Recommender** made with **Streamlit**.")

        st.markdown("""The data for this project comes from the following website: 
                       [Open Dataset](https://www.kaggle.com/datasets/utsavdey1410/food-nutrition-dataset).""")

        st.write("""To use this app just go to the `Food Recommender` section to know more about the data that we used to build
        ...
        tab1, tab2 = st.tabs(["Exploratory Data Analysis", "Machine Learning Model", "Data"])
